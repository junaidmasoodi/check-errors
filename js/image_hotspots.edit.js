  ...
  Drupal.behaviors.imageHotspotsEdit = {
    attach: function (context, settings) {
      $('.image-hotspots-wrapper:not(.init-edit)', context).once('imageHotspotsEdit').each(function () {
        ...
        // Define width.
        if (divs.$image.width() < divs.$image.height()) {
          divs.$wrapper.width(250);
          $wrapper.addClass('big-image');
        }
        if (divs.$image.width() > divs.$image.height()) {
          divs.$wrapper.width(600);
        }
        ...
        $wrapper.removeClass('init-view');
        $('.hotspot').removeClass('hotspot--view');
        ...
        function showEditForm(hotspot_data, position, dimensions) {
          $('.js-form-item-hotspots-title').removeClass('js-form-type-textfield');
          $('.js-form-item-hotspots-description-value').removeClass('js-form-type-textarea');
          $('.js-form-item-hotspots-link').removeClass('js-form-type-textfield');
          ...
          CKEDITOR.instances['edit-hotspots-description-value'].setData(hotspot_data.description);
